 ...
 * @author Jim Dixon
 */
public class U256x256 extends U {

    // ACCESS METHODS ///////////////////////////////////////////////
    public int getDirStruc() { return DIR256x256;   }
     ...
     */
    protected U256x256 (String dirName, boolean lazy)   throws IOException {
        super(dirName, DIR256x256, lazy);
    ...
    public StringBuffer chkDirFixPath(StringBuffer sb, String key) {
        sb.append( '/' )
          .append( key.substring(0, 2) )
          .append( '/' )
          .append( key.substring(2, 4) );
        return sb;
    }
    /**
