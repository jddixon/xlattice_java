 ...
 * @author Jim Dixon
 */
public class UFlat extends U {

    // ACCESS METHODS ///////////////////////////////////////////////
    public int getDirStruc() { return FLAT_DIR; }
     ...
     */
    protected UFlat (String dirName, boolean lazy)  throws IOException {
        super(dirName, FLAT_DIR, lazy);
    ...
    public byte[] put (final byte[] data)       throws IOException {
        SHA1 sha1 = new SHA1();
        byte[] key = sha1.digest(data);
        String hexKey = byteArrayToHex(key);
        String fileName = uDirName + "/" + hexKey;
