...
/**
 * Tests the SimpleTlsClient and SimpleTlsServer against one another.
 *
 * @author Jim Dixon
 */

public class TestSimpleTls extends TestCase implements TlsConst {
    ...
    protected void DEBUG_MSG(String s) {
        debugLog.message("TestSimpleTls: " + s);
    }
    // CONSTRUCTORS /////////////////////////////////////////////////
    public TestSimpleTls (String name)          throws Exception {
        super(name);
        rng = new Random();
    ...
    public void testServerConstructor()         throws Exception {
